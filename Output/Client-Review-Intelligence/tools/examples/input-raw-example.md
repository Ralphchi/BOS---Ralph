# Raw input — Dr. Marc Perrin (fictional, Q1 2026)
...
Addressee scope: single named individual (review is addressed 1:1 to Dr. Marc Perrin, not to the household)
...
Personal notes:
- spouse Sylvie Perrin, 3 children (28/32/35), first grandchild due May 2026
...
Top detractors:
- Nestlé direct: -2.4% (softer water segment, China pressure). Contribution: 7.3% × -2.4% ≈ -17.5 bps.
...
- SNB held rates at 0.75% in March; inflation expectations anchored at 1.1%.
...
- Luxury sector strong rebound after weak 2025: Chinese affluent consumer re-engagement, US resilience.
...
```
<firm_voice_sample>
Sample 1 (previous quarter commentary, addressed 1:1 to Dr. Marc Perrin):
...
Observations: Register 1:1 formel. Geneva boutique understated. Signature phrases: "continuité prudente", "créateur de valeur", "discipline de l'allocation". Hedging verbs: "restons", "n'apporterons que", "vous recommandons de ne pas".
</firm_voice_sample>
```
